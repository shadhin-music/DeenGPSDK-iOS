...
typedef SWIFT_ENUM(NSInteger, AppFeature, open) {
  ...
  AppFeatureTasbeeh = 3,
  AppFeatureQuran = 4,
  AppFeatureIslamic_name = 5,
  AppFeaturePrayer_time = 6,
  AppFeatureCompass = 7,
  AppFeatureZakat = 8,
  AppFeatureIslamic_event = 9,
  AppFeatureNearest_mosque = 10,
  AppFeatureEid_jamat = 11,
  AppFeaturePrayer_learning = 12,
  AppFeatureLive_makkah_madina = 13,
  AppFeatureDuaAndAmol = 14,
  AppFeatureIslamic_golpo = 15,
  AppFeatureRamadan = 16,
  AppFeatureRamadan_regular = 17,
  AppFeatureHajjandumrah = 18,
  AppFeatureKhatam_e_quran = 19,
  AppFeatureQurbani = 20,
  AppFeatureIslamic_boyan = 21,
  ...
  AppFeatureMore_menu = 30,
  AppFeatureMuslim_res = 31,
  AppFeatureDeen_ai = 32,
  AppFeatureDeenai = 33,
  AppFeatureDua_amal = 34,
  AppFeatureKhatam_e_quran_ramadan = 35,
  AppFeatureRamadan_book = 36,
  AppFeatureRamadan_boyan = 37,
  AppFeatureRamadan_dua = 38,
  AppFeatureRamadan_eid = 39,
  AppFeatureRamadan_fazayel_masayel = 40,
  AppFeatureRamadan_fitra = 41,
  AppFeatureRamadan_hadith = 42,
  AppFeatureRamadan_health_tips = 43,
  AppFeatureRamadan_info = 44,
  AppFeatureRamadan_itikaf = 45,
  AppFeatureRamadan_laylatul_qadr = 46,
  AppFeatureRamadan_tarabih = 47,
  AppFeatureRamadan_tracker = 48,
  AppFeatureIe_sab_e_barat = 49,
};
...
SWIFT_CLASS("_TtC12DeenIslamSDK9GraphView")
...
@class IQInvocation;
SWIFT_CLASS("_TtC12DeenIslamSDK15IQBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12DeenIslamSDK28IQBarButtonItemConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12DeenIslamSDK12IQInvocation") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12DeenIslamSDK26IQKeyboardReturnKeyHandler") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(DeenIslamSDK)) <UITextFieldDelegate>
- (BOOL)textFieldShouldBeginEditing:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(DeenIslamSDK)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC12DeenIslamSDK18IQPreviousNextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12DeenIslamSDK10IQTextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12DeenIslamSDK20IQTitleBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC12DeenIslamSDK9IQToolbar") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIImage (SWIFT_EXTENSION(DeenIslamSDK))
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIScrollView (SWIFT_EXTENSION(DeenIslamSDK))
