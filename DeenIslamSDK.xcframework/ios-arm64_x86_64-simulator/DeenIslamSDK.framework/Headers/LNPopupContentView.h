 ...
 */
@property (nonatomic) LNPopupCloseButtonStyle dn_popupCloseButtonStyle;

/**
 * The popup close button. (read-only)
 */
@property (nonatomic, strong, readonly) LNPopupCloseButton* dn_popupCloseButton;

/**
 * Move close button under navigation bars
 */
@property (nonatomic) BOOL dn_popupCloseButtonAutomaticallyUnobstructsTopBars;
 ...
 */
@property (nonatomic, assign) UIBlurEffectStyle dn_backgroundStyle UI_APPEARANCE_SELECTOR;

/**
 * A Boolean value that indicates whether the popup conetnt view is translucent (@c YES) or not (@c NO).
 */
@property(nonatomic, assign, getter=isTranslucent) BOOL dn_translucent UI_APPEARANCE_SELECTOR;
